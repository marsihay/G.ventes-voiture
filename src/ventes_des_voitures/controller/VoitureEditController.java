 ...
 * @author Marsihay
 */
public class VoitureEditController implements Initializable {
    double x, y;
    Statement stmt;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
            ...
            if(resultat.next()){
                numVlbl.setText(resultat.getString("num_voiture"));
                marqueVlbl.setText(resultat.getString("marque"));
                puVlbl.setText(resultat.getString("pu"));
                stockVlbl.setText(resultat.getString("stock"));
            }
    ...
    if(event.getSource()== close){
        ...
        stage.close();
          ...
          String requete ="UPDATE voiture SET marque='"+marque+"', pu='"+pu+"', stock='"+stock+"' Where num_voiture='"+num_voiture+"'; ";
        try{
